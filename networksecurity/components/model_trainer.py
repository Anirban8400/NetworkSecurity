...
# Initialize DagsHub
# dagshub.init(
#     repo_owner="Anirban8400",
#     repo_name="NetworkSecurity",
#     mlflow=True
# )

# # Force MLflow to use the correct tracking endpoint
# mlflow.set_tracking_uri("https://dagshub.com/Anirban8400/NetworkSecurity.mlflow")
# mlflow.set_experiment("default")

# dagshub.init(repo_owner='anirban8400',
#              repo_name='NetworkSecurity',
#              mlflow=True)
...
class ModelTrainer:
    ...
    def train_model(self, x_train, y_train, x_test, y_test):
        ...
        model_trainer_artifact = ModelTrainerArtifact(
            ...
            train_metric__artifact=classification_train_metric,
            test_metric__artifact=classification_test_metric
        )
    ...
    def initiate_model_trainer(self) -> ModelTrainerArtifact:
        try:
            ...
            x_train, y_train = train_arr[:, :-1], train_arr[:, -1]   # take last column for y 
