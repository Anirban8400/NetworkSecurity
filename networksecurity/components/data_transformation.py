...
from networksecurity.constant.trainning_pipeline import TARGET_COLUMN
from networksecurity.constant.trainning_pipeline import DATA_TRANSFORMATION_INPUTER_PARAMS
