...
import certifi   #makes sure that the http requests are made to trusted servers by looking at root certificates
...
if __name__=='__main__':
    FILE_PATH=r"E:\ML-COURSE\NetworkSecurity\Network_Data\phisingData.csv"
    DATABSE="Anirban"
    Collection='NetworkDat'
